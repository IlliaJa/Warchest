...
if __name__ == '__main__':
    ...
    cartpole_policy = Policy(
        action_dim=cartpole_hyperparameters["action_space"],
        device=cartpole_hyperparameters["device"],
        hidden_dim=cartpole_hyperparameters["hidden_dim"]).to(device)
